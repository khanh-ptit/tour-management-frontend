import { message, QRCode, Tag } from "antd";
import { useEffect, useState } from "react";
import { Link, useParams } from "react-router-dom";
import { getOrderDetail } from "../../../services/client/order.service";
...
function OrderDetail() {
  ...
  useEffect(() => {
    ...
    if (createOrderSuccessMessage) {
      messageApi.open({
        type: "success",
        content: createOrderSuccessMessage,
      });
  ...
  const qrPaymentUrl = `https://sepay.vn/pay?bank=MB&account=0002033567932&amount=${order.totalPrice}`;
              ...
              <div className="col-4">
                {!order.isPaid && (
                  <>
                    ...
                    <QRCode value={qrPaymentUrl} size={180} />
                    <p className="mt-2">
